...
- [x] Reduce diagonal hatching and internal grid emphasis. Strengthen the outer borders of connected territories.
- [x] Add map zoom and a “Centre on my company” control.
